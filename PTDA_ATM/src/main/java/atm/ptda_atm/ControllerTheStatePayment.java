...
public class ControllerTheStatePayment {
            ...
            if (payAmount > availableBalance) {
                ...
                timeline.setOnFinished(e -> {
                    if (!validatePayment(ref,am)) {
                        ...
                        boolean success = performStatePayment(clientCardNumber, Float.parseFloat(am));
    ...
    private boolean performStatePayment(String clientCardNumber, float amount) {
        ...
        boolean debitSuccess = movement(clientCardNumber, amount, "Debit", "State Payment");
